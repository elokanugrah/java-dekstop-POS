 ...
 * @author Elok Anugrah
 */
public class frameBotol extends javax.swing.JFrame {
    ...
    String[] headerTable = {"Kode Botol", "Nama Botol", "Harga Botol"};
    /**
     * Creates new form frameBotol
     */
    public frameBotol() {
        initComponents();
        ...
        headerTable();
        hitungBotol();
        //Mengatur ukuran kolom tabel botol
        ...
        //Mengatur posisi header kolom tabel botol dengan membuat objek baru renderingKanan() maupun renderingTengah();
    ...
    //Mengurutkan kolom dari rendah ke tinggi atau sebaliknya ketika men-klik header kolom
    public void sortTable(){
       jTable1.setAutoCreateRowSorter(true);
    }
    
    //Agar header tabel dapat diatur posisinya
    ...
    public void tableParfum(){
        ...
        try {
            ...
            ResultSet res = statement.executeQuery("SELECT kode_botol, nama_botol, harga_botol FROM tb_botol");
                while (res.next()) {
                    String kolom1 = res.getString("kode_botol");
                    String kolom2 = res.getString("nama_botol");
                    String kolom3 = res.getString("harga_botol");
    ...
    //Constructor untuk memfilter/mencari dan ditampilkan langsung pada tabel parfum
    ...
    //Menampilkan jumlah, nilai maksimal, dan nilai minimal data botol
    private void hitungBotol(){
        String sql = "SELECT COUNT( kode_botol ) AS jumlah, MAX( harga_botol ) AS mak, MIN( harga_botol ) AS min FROM tb_botol";
        try {
            java.sql.Statement statement = (java.sql.Statement) koneksi.GetConnection().createStatement();
            ResultSet res = statement.executeQuery(sql);
            while(res.next()){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Botol", "Nama Botol", "Harga Botol"
            }
        ) {
        ...
        jLabel30.setText("Kode Botol :");

        jLabel31.setText("Nama Botol :");

        jLabel37.setText("Harga Botol :");
        ...
        jLabel10.setText("Harga Botol Termahal :");
        ...
        jLabel4.setText("Harga Botol Termurah :");
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        fieldKodeBotol = jTextField17.getText();
        fieldNamaBotol = jTextField20.getText();
        fieldHargaBotol = jTextField21.getText();
        ...
        try{
            if ("".equals(fieldKodeBotol) || "".equals(fieldNamaBotol) || "".equals(fieldHargaBotol)) {
                ...
                statement.executeUpdate("UPDATE tb_botol SET nama_botol='"+fieldNamaBotol+"',harga_botol='"+fieldHargaBotol+"' WHERE kode_botol='"+fieldKodeBotol+"';");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if ("".equals(fieldKodeBotol) || "".equals(fieldNamaBotol) || "".equals(fieldHargaBotol)) {
            ...
            try {
                Statement statement = (Statement) koneksi.GetConnection().createStatement();
                statement.executeUpdate("DELETE FROM tb_botol WHERE kode_botol='"+fieldKodeBotol+"'");
                frameBotol frame = new frameBotol();
                frame.setVisible(true);
                this.dispose();
            } catch (Exception e) {
    ...
    private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
        ...
        String sqlSearch = "SELECT kode_botol, nama_botol, harga_botol FROM tb_botol WHERE kode_botol LIKE'%"+fieldFilter+"%' OR nama_botol LIKE'%"+fieldFilter+"%' OR harga_botol LIKE'%"+fieldFilter+"%';";
        search(sqlSearch);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameBotol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameBotol().setVisible(true);
            }
        });
    }
